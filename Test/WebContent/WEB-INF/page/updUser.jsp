...
<body>
	...
	<input type="hidden" id="id2" name="id2" value="${objUser.id}" /><!-- 存放查询出User的id值 -->

	<div class="container">
		<div class="row">
			<div class="col-sm-4"></div>
			<div class="col-sm-4">修改User</div>
			<div class="col-sm-4"></div>
		</div>
		<hr />
		<div class="row">
			...
			<div class="col-sm-2">
				<input id="name" name="name" type="text" class="form-control" value="${objUser.name }"><!-- id和name为实体类的属性 -->
		...
		<div class="row">
			...
			<div class="col-sm-2">
				<input id="telephone" name="telephone" type="text" class="form-control" value="${objUser.telephone }">
			</div>
		</div>
		<br />
		<div class="row">
...
<script type="text/javascript">
	...
	$("document").ready(function() {
		$("#btnOk").click(function() {
			...
			$.ajax({
				type : "post",
				url : "${pageContext.request.contextPath }/user/showUpdUserData",
				data : {
					id:$("#id2").val(),
					name:$("#name").val(),
